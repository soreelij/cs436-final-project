            ...
            <div>
                <div className="row">
                    { this.state.images.length === 3 ?
                        <div>
                            <p>Choose your favorite cover for our album.</p>
                            {this.state.images.map((image, index) => (
                                <div key={index}>
                                    <button className="neumorph mt-3 mb-3" onClick={() => this.props.clickImgBtn(image)}>{
                                        <div key={index} className="col-lg-4 col-md-4 col-xs-4">
                                            <img className="p-3" alt="An image generated by the generator" height="256" width="256" src={image} />
                                        </div>
                                    }</button>
                                </div>
                            ))}
